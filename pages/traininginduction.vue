...
<script>
  export default {
    ...
    methods: {
      ...
      this.$axios.get(`traininginduction`).then(res => this.data = res.data);
      ...
      save () {
        ...
        var payload = {
                        ...
                        "subject": "test",
                        "no_attendees": 2,
                        "attachments": "http://localhost:8000/uploads/trainingInduction/ORD_CUP.jpg",
    };
       
          
              this.$axios.post('traininginduction',payload)
              .then((res) => {
