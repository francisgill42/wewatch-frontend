<template>
  ...
  >
        ...
        <v-dialog v-model="dialog" max-width="900px">
          ...
          <v-card>
            <v-card-title>
              ...
              <v-spacer />
               <v-btn raised class="primary mt-2" @click="onPickFile">
          ...
          >
            OK
                  ...
                  <v-col cols="6" sm="6" md="6">
                   ...
                   <v-col cols="6" sm="6" md="6">
                    <v-text-field v-model="editedItem.zones" :label="`No of zones you want to create`"></v-text-field>
    ...
    <template v-slot:item.zones="{item}">
        ...
        <v-chip class="ma-1" color="secondary" small v-for="(zone,i) in item.zones" :key="i" >
          <span>
            {{zone.zone_name}}
          </span>
        </v-chip>
     ...
     <template v-slot:item.project_logo="{item}">
      <div class="pa-5" >
        <v-img width="150px" :src="item.project_logo" />
      </div>
    </template>
    ...
    methods: {
      ...
      save () {
       ...
       //   Object.assign(this.data[this.editedIndex], this.editedItem)
            ...
            this.$axios.post('project/' + this.editedItem.id, payload)
            .then(res => {
