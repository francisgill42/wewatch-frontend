...
<br>
    ...
    <br>
     ...
     <v-row>
      ...
      <h2 class="">9.	Procurement Request 	<span style="color:red"> (Operational HSE or Security Equipment Requirement) (Both) </span> </h2>
     ...
     <v-row>
      ...
      <h2 class="">10.	Red Flag 	<span style="color:red"> (Both) </span> </h2>
